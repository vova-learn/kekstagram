...
Наставник: [Yulia Koretskaya](https://github.com/yulllll)
Дeмо: [Проект «Кекстаграм»](https://vovapipko.github.io/kekstagram/ "Проект «Кекстаграм»")

Проект был создан в рамках ученого онлайн‑курса **«JavaScript, уровень 1»** от htmlacademy.ru, продолжительностью 9 недель. Проект создавался под руководством наставника, который давал обратную связь по результату проделанной работы.
